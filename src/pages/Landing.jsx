    ...
    <div className="min-h-screen">
      ...
      <section id="trust" className="px-6 md:px-10 pt-10 pb-20 grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-5 text-base md:text-lg text-muted-foreground max-w-lg">
            The B2B compliance layer for modern deals. Authenticate businesses, surface risk flags, and
            underwrite trust with a transparent, audit-grade score.
          </p>

          <form onSubmit={handleLogin} className="mt-8 glass-card p-5 max-w-md">
            <div className="text-xs uppercase tracking-[0.18em] text-muted-foreground mb-3">Sign in</div>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="relative glass-card p-8 w-full max-w-md">
            <div className="flex items-center justify-between mb-6">
              <div>
                <div className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Live Profile</div>
      ...
      <section id="features" className="px-6 md:px-10 py-16 border-t border-border bg-card/40">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-display font-bold tracking-tight">Built for trust, audited by design.</h2>
          <p className="text-muted-foreground mt-2 max-w-2xl">Three pillars power every score on TrustGrid.</p>
